 ...
 * {@link OpenResultsFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link OpenResultsFragment#newInstance} factory method to
 * create an instance of this fragment.
 *
 */
public class OpenResultsFragment extends Fragment {
    ...
    public static final String TAG = "OpenResultsFragment";
    ...
    public static OpenResultsFragment newInstance(String param1, String param2) {
        OpenResultsFragment fragment = new OpenResultsFragment();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        onChildViewAttachedListener.OnChildViewAttached(OpenResultsFragment.TAG);
    ...
    public static OpenResultsFragment newInstance(String param1) {
        OpenResultsFragment fragment = new OpenResultsFragment();
        Bundle args = new Bundle();
        PARENT_TAG = param1;
    ...
    public static OpenResultsFragment newInstance() {
        OpenResultsFragment fragment = new OpenResultsFragment();
        Bundle args = new Bundle();
...
//        return inflater.inflate(R.layout.fragment_event_locator, container, false);
        ...
        View rootView = inflater.inflate(R.layout.fragment_open_results,container,false);

        openResults = (TextView) rootView.findViewById(R.id.openresults);
