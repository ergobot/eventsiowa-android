...
//            setIdToken(intent.getStringExtra(NavigationActivity.ID_TOKEN));
            signout = intent.getBooleanExtra("SIGN_OUT",false);
        }
...
//        hTextView.animateText("Discover");
...
//            setIdToken(intent.getStringExtra(NavigationActivity.ID_TOKEN));
    ...
    String[] sentences = new String[]{"Discover", "Realize", "Explore", "Catch", "unearth", "Locate", "Find", "Treasure", "Visualize", "Search", "Research", "Tour", "Travel", "Know", "Share", "Look", "Dig", "Sort", "Favorite", "Uncover", "Locate", "Review", "Learn"};
